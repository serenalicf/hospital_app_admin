...
export const constantRouterMap = [
...

  {
    ...
    meta: { title: 'Hospital Setting Management', icon: 'example' },
    children: [
      {
        path: 'list',
        name: 'List Hospital Setting',
        component: () => import('@/views/hospitalSetting/list'),
        meta: { title: 'List Hospital Setting' }
      },
      {
        path: 'add',
        name: 'Add Hospital Setting',
        component: () => import('@/views/hospitalSetting/add'),
        meta: { title: 'Add Hospital Setting' }
      },
      {
        path: 'edit/:id',
        name: 'Edit Hospital Setting',
        component: () => import('@/views/hospitalSetting/add'),
        meta: { title: 'Edit Hospital Setting', noCache: true },
        hidden: true // hidden router
      }
    ]
  },
  {
